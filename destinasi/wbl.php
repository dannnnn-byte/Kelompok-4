...
if (isset($_POST['edit_review']) && $isLogin) {
    ...
    if ($hasil) {
        ...
        echo "<script>alert('Ulasan Anda berhasil diperbarui!'); window.location='wbl.php';</script>";
        exit;
    } else {
...
if (isset($_POST['delete_review']) && $isLogin) {
    ...
    if ($hasil) {
        ...
        echo "<script>alert('Ulasan berhasil dihapus!'); window.location='wbl.php';</script>";
        exit;
    } else {
...
if (isset($_POST['reply_admin']) && $isAdmin) {
    ...
    echo "<script>alert('Balasan admin berhasil dikirim'); window.location='wbl.php';</script>";
    exit;
}
?>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end">
      ...
      <?php if ($isAdmin): ?>
        ...
        <li>
          <a class="dropdown-item"
             href="<?= $basePath ?>admin/ulasan.php">
             Kelola Ulasan
          </a>
        </li>
