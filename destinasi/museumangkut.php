...
if (isset($_POST['submit_review']) && $isLogin) {
    ...
    if ($rating && $komentar) {
        ...
        echo "<script>alert('Terima kasih! Ulasan Anda berhasil dikirim.'); window.location='museumangkut.php';</script>";
        exit;
    } else {
...
if (isset($_POST['edit_review']) && $isLogin) {
    ...
    if ($hasil) {
        ...
        echo "<script>alert('Ulasan Anda berhasil diperbarui!'); window.location='museumangkut.php';</script>";
        exit;
    } else {
...
if (isset($_POST['delete_review']) && $isLogin) {
    ...
    if ($hasil) {
        ...
        echo "<script>alert('Ulasan berhasil dihapus!'); window.location='museumangkut.php';</script>";
        exit;
    } else {
